...
{
    public class LaserParticleSystem : ParticleEmitter2D
    {
        public Vector3 WorldPosition;

        public LaserParticleSystem(Vector2 position, uint maxNumberOfParticles, Vector3 worldPosition)
        ...
        {                     
            ...
            OnEmission += LaserParticleSystem_OnEmission;
            OnNoActiveParticlesRemaining += LaserParticleSystem_OnNoActiveParticlesRemaining;
        ...
        void LaserParticleSystem_OnNoActiveParticlesRemaining(object sender, Anarian.Events.AnarianEventArgs e)
        {
            OnNoActiveParticlesRemaining -= LaserParticleSystem_OnNoActiveParticlesRemaining;
        }

        void LaserParticleSystem_OnEmission(object sender, Anarian.Events.AnarianEventArgs e)
        {
        }
